...
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony import */ var _createTodo__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./createTodo */ \"./src/createTodo.js\");\n/* harmony import */ var _style_css__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./style.css */ \"./src/style.css\");\n/* harmony import */ var _projects__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./projects */ \"./src/projects.js\");\n/* harmony import */ var _createProject__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./createProject */ \"./src/createProject.js\");\n/* harmony import */ var _DOMstuff__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./DOMstuff */ \"./src/DOMstuff.js\");\n\n\n\n\n\n\nfunction pageSetup() {\n  const testy = new _createTodo__WEBPACK_IMPORTED_MODULE_0__[\"default\"]('Test todo', 'this is a test todo', '12/4/21', 'high');\n  const testy2 = new _createTodo__WEBPACK_IMPORTED_MODULE_0__[\"default\"](\n    'Second todo',\n    'do this one second',\n    '12/16/21',\n    'low'\n  );\n  const testy3 = new _createTodo__WEBPACK_IMPORTED_MODULE_0__[\"default\"]('For second project', 'test', '1/11/01', 'medium');\n  const defaultProject = new _createProject__WEBPACK_IMPORTED_MODULE_3__[\"default\"]('Default Project');\n  const secondProject = new _createProject__WEBPACK_IMPORTED_MODULE_3__[\"default\"]('Second Project');\n  window.currentProject = defaultProject;\n  defaultProject.addTodo(testy);\n  defaultProject.addTodo(testy2);\n  secondProject.addTodo(testy3);\n  (0,_projects__WEBPACK_IMPORTED_MODULE_2__.pushToProjects)(defaultProject);\n  (0,_projects__WEBPACK_IMPORTED_MODULE_2__.pushToProjects)(secondProject);\n  const newProjectBtn = document.querySelector('.newProjectBtn');\n  const newTodoBtn = document.querySelector('.newTodoBtn');\n  const form = document.querySelector('form');\n  const closeBtn = document.querySelector('#closeForm');\n  newProjectBtn.addEventListener('click', _DOMstuff__WEBPACK_IMPORTED_MODULE_4__.makeNewProject);\n  newTodoBtn.addEventListener('click', _DOMstuff__WEBPACK_IMPORTED_MODULE_4__.openTheForm);\n  closeBtn.addEventListener('click', _DOMstuff__WEBPACK_IMPORTED_MODULE_4__.closeTheForm);\n  (0,_DOMstuff__WEBPACK_IMPORTED_MODULE_4__.populateMain)(defaultProject);\n  form.addEventListener('submit', (e) => {\n    e.preventDefault();\n    const titleInput = document.getElementById('title');\n    const descriptionInput = document.getElementById('description');\n    const dueDateInput = document.getElementById('dueDate');\n    const priorityInput = document.getElementById('priority');\n    const freshTodo = new _createTodo__WEBPACK_IMPORTED_MODULE_0__[\"default\"](\n      titleInput.value,\n      descriptionInput.value,\n      dueDateInput.value,\n      priorityInput.value\n    );\n    console.log(freshTodo);\n    defaultProject.addTodo(freshTodo);\n    (0,_DOMstuff__WEBPACK_IMPORTED_MODULE_4__.populateMain)(window.currentProject);\n    // displayTodo();\n    // addBookToLibrary(freshBook);\n    // clearCards();\n    // displayLibrary();\n    // saveArray();\n  });\n}\n\npageSetup();\n(0,_DOMstuff__WEBPACK_IMPORTED_MODULE_4__.anchorLoop)();\n\n// Each todo will go inside a project, new projects can be created with separate todo lists.\n// Theres a default project called 'default'\n\n// PROJECTS are objects that store TODOs (objects), they are stored in PROJECTLIST (array)\n\n// Next:\n// Add functionality to indicate a todo is complete\n\n\n//# sourceURL=webpack://todo-list/./src/index.js?");
